      ...
      datasets: [
        {
          ...
          data: [
            5000000, 7000000, 8000000, 9500000, 10000000, 7500000, 8500000,
            11000000, 9500000, 12000000, 10500000, 13000000,
          ],
      ...
      datasets: [
        {
          ...
          data: [
            50000000, 55000000, 60000000, 70000000, 75000000, 80000000,
            85000000,
          ],
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <header className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500">
              Manage your Korean-themed events and monitor revenue.
            </p>
          </div>
          <Image
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          ...
          <ul className="space-y-4">
            {[
              {
                name: "BTS World Tour: Music Concert",
                date: "2024-06-10",
                category: "MUSIC",
                price: 150000,
                revenue: 15000000,
              ...
              {
                name: "Crash Landing on You: Theater Show",
                date: "2024-06-20",
                category: "THEATER",
                price: 125000,
                revenue: 9000000,
              ...
              {
                name: "K-League Sports Championship",
                date: "2024-07-01",
                category: "SPORTS",
                price: 50000,
                revenue: 5000000,
              ...
              >
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Date: {event.date} | Category: {event.category} | Price:{" "}
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <ul className="space-y-4">
            {[
              ...
              {
                customer: "Jane Smith",
                event: "Running Man Fanmeet",
                amount: 750000,
                status: "PENDING",
              },
              {
                customer: "Michael Brown",
                event: "Seoul Tech Seminar",
                amount: 600000,
                status: "FAILED",
              },
